<?php
namespace EPOCHENAPOLEON\EpochenapoleonCeNormdata\Hooks;
...
class PageLayoutViewDrawItem implements PageLayoutViewDrawItemHookInterface
{
  ...
  'epochenapoleoncenormdata_epochenapoleon_normdata' => 'EpochenapoleonNormdata',
);
    ...
    protected function configureView(array $pageTsConfig, $contentType)
    {
        ...
        if (!empty($previewConfiguration[$contentType])) {
            GeneralUtility::deprecationLog('Setting the complete template path with filename is deprecated and will be removed in epochenapoleoncenormdata_export 3.0');
            ...
            if (!empty($previewConfiguration[$extensionKey]['templateRootPath'])) {
                $this->view->setTemplateRootPaths([
                    'EXT:epochenapoleon_ce_normdata/Resources/Private/Backend/Templates/Content/',
            ...
            if (!empty($previewConfiguration[$extensionKey]['layoutRootPath'])) {
                $this->view->setLayoutRootPaths([
                    'EXT:epochenapoleon_ce_normdata/Resources/Private/Backend/Layout/',
            ...
            if (!empty($previewConfiguration[$extensionKey]['partialRootPath'])) {
                $this->view->setPartialRootPaths([
                    'EXT:epochenapoleon_ce_normdata/Resources/Private/Backend/Partials/',
